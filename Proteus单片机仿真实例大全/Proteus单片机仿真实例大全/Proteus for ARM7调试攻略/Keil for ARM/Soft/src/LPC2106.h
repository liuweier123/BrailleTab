...
#define EXTWAKE         (*((volatile unsigned char *) 0xE01FC144))		//外部中断唤醒,是否从处理器掉电中唤醒
...
/* 存储器加速模块 */
#define MAMCR           (*((volatile unsigned char *) 0xE01FC000))		//控制
#define MAMTIM          (*((volatile unsigned char *) 0xE01FC004))		//定时控制

/* Vectored Interrupt Controller (VIC) */
/* 向量中断控制器(VIC)的特殊寄存器 */
#define VICIRQStatus    (*((volatile unsigned long *) 0xFFFFF000))		//IRQ状态
#define VICFIQStatus    (*((volatile unsigned long *) 0xFFFFF004))		//FIQ状态
#define VICRawIntr      (*((volatile unsigned long *) 0xFFFFF008))		//所有中断的状态
#define VICIntSelect    (*((volatile unsigned long *) 0xFFFFF00C))		//中断选择
#define VICIntEnable    (*((volatile unsigned long *) 0xFFFFF010))		//中断使能
#define VICIntEnClr     (*((volatile unsigned long *) 0xFFFFF014))		//中断使能清零

#define VICSoftInt      (*((volatile unsigned long *) 0xFFFFF018))		//软件中断
#define VICSoftIntClear (*((volatile unsigned long *) 0xFFFFF01C))		//软件中断清零

#define VICProtection   (*((volatile unsigned long *) 0xFFFFF020))		//保护使能
#define VICVectAddr     (*((volatile unsigned long *) 0xFFFFF030))		//向量地址
#define VICDefVectAddr  (*((volatile unsigned long *) 0xFFFFF034))		//默认地址

#define VICVectAddr0    (*((volatile unsigned long *) 0xFFFFF100))		//向量地址
...
#define VICVectCntl0    (*((volatile unsigned long *) 0xFFFFF200))		//向量控制
