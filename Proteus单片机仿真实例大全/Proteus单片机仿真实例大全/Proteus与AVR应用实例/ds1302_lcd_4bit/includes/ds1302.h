...
void write_byte(unsigned char w_byte, unsigned char w_2_byte);
unsigned char read_byte(unsigned char w_byte);
unsigned char get_hours(void);
#else
extern void reset(void);		//define the functions
extern void write(unsigned char W_Byte);
extern unsigned char read(void);
extern void write_byte(unsigned char w_byte, unsigned char w_2_byte);
extern unsigned char read_byte(unsigned char w_byte);
